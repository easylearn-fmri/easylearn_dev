...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.listWidget_selected_datasets = QtWidgets.QListWidget(self.groupBox_selected)
        self.listWidget_selected_datasets.setContextMenuPolicy(QtCore.Qt.CustomContextMenu)
        self.listWidget_selected_datasets.setAcceptDrops(True)
        self.listWidget_selected_datasets.setDragEnabled(False)
        self.listWidget_selected_datasets.setDragDropMode(QtWidgets.QAbstractItemView.DropOnly)
        self.listWidget_selected_datasets.setObjectName("listWidget_selected_datasets")
        self.gridLayout_6.addWidget(self.listWidget_selected_datasets, 0, 0, 1, 1)
        ...
        self.tabWidget_CV = QtWidgets.QTabWidget(self.groupBox_3)
        ...
        self.listWidget_candidate_datasets = QtWidgets.QListWidget(self.groupBox_candidate)
        self.listWidget_candidate_datasets.setAcceptDrops(False)
        self.listWidget_candidate_datasets.setDragEnabled(True)
        self.listWidget_candidate_datasets.setObjectName("listWidget_candidate_datasets")
        self.verticalLayout.addWidget(self.listWidget_candidate_datasets)
