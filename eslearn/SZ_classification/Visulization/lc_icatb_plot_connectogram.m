...
%     'DMN', 61:100;        % DMN comps
%     'ATTN', 101:200; % ATTN Comps
...
% a. lc_icatb_plot_connectogram(comp_network_names, 'C', C, 'threshold', 1, 'image_file_names', [], 'colorbar_label', 'Corr', 'comp_labels', comp_labels, 'line_width', 0.2, 'display_type', 'no');
