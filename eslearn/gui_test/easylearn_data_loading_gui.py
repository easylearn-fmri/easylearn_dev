...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_file_mask = QtWidgets.QVBoxLayout()
        self.verticalLayout_file_mask.setObjectName("verticalLayout_file_mask")
        self.label_mask = QtWidgets.QLabel(self.centralwidget)
        self.label_mask.setObjectName("label_mask")
        self.verticalLayout_file_mask.addWidget(self.label_mask)
        ...
        self.verticalLayout_file_mask.addWidget(self.lineEdit_mask)
        self.file_btn_2 = QtWidgets.QHBoxLayout()
        self.file_btn_2.setObjectName("file_btn_2")
        self.pushButton_chooseMask = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_chooseMask.setMinimumSize(QtCore.QSize(20, 40))
        self.pushButton_chooseMask.setBaseSize(QtCore.QSize(10, 10))
        self.pushButton_chooseMask.setToolTipDuration(-5)
        self.pushButton_chooseMask.setObjectName("pushButton_chooseMask")
        self.file_btn_2.addWidget(self.pushButton_chooseMask)
        ...
        self.verticalLayout_file_mask.addLayout(self.file_btn_2)
        self.horizontalLayout.addLayout(self.verticalLayout_file_mask)
        spacerItem3 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout.addItem(spacerItem3)
        self.verticalLayout_file_target = QtWidgets.QVBoxLayout()
        self.verticalLayout_file_target.setObjectName("verticalLayout_file_target")
        self.label_target = QtWidgets.QLabel(self.centralwidget)
        self.label_target.setObjectName("label_target")
        self.verticalLayout_file_target.addWidget(self.label_target)
        self.lineEdit_target = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit_target.setMinimumSize(QtCore.QSize(30, 30))
        self.lineEdit_target.setObjectName("lineEdit_target")
        self.verticalLayout_file_target.addWidget(self.lineEdit_target)
        self.file_btn_3 = QtWidgets.QHBoxLayout()
        self.file_btn_3.setObjectName("file_btn_3")
        self.pushButton_chooseTarget = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_chooseTarget.setMinimumSize(QtCore.QSize(20, 40))
        self.pushButton_chooseTarget.setBaseSize(QtCore.QSize(10, 10))
        self.pushButton_chooseTarget.setToolTipDuration(-5)
        self.pushButton_chooseTarget.setObjectName("pushButton_chooseTarget")
        self.file_btn_3.addWidget(self.pushButton_chooseTarget)
        ...
        self.verticalLayout_file_target.addLayout(self.file_btn_3)
        self.horizontalLayout.addLayout(self.verticalLayout_file_target)
        spacerItem4 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout.addItem(spacerItem4)
        self.verticalLayout_file_covariance = QtWidgets.QVBoxLayout()
        self.verticalLayout_file_covariance.setObjectName("verticalLayout_file_covariance")
        self.label_covariance = QtWidgets.QLabel(self.centralwidget)
        self.label_covariance.setObjectName("label_covariance")
        self.verticalLayout_file_covariance.addWidget(self.label_covariance)
        self.lineEdit_cov = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit_cov.setMinimumSize(QtCore.QSize(30, 30))
        self.lineEdit_cov.setObjectName("lineEdit_cov")
        self.verticalLayout_file_covariance.addWidget(self.lineEdit_cov)
        self.file_btn_4 = QtWidgets.QHBoxLayout()
        self.file_btn_4.setObjectName("file_btn_4")
        self.pushButton_chooseCovariance = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_chooseCovariance.setMinimumSize(QtCore.QSize(20, 40))
        self.pushButton_chooseCovariance.setBaseSize(QtCore.QSize(10, 10))
        self.pushButton_chooseCovariance.setToolTipDuration(-5)
        self.pushButton_chooseCovariance.setObjectName("pushButton_chooseCovariance")
        self.file_btn_4.addWidget(self.pushButton_chooseCovariance)
        ...
        self.verticalLayout_file_covariance.addLayout(self.file_btn_4)
        self.horizontalLayout.addLayout(self.verticalLayout_file_covariance)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_chooseMask.setWhatsThis(_translate("MainWindow", "<html><head/><body><p>push the button then close program</p></body></html>"))
        self.pushButton_chooseMask.setText(_translate("MainWindow", "Choose"))
        self.pushButton_clearMask.setText(_translate("MainWindow", "Clear"))
        self.label_target.setText(_translate("MainWindow", "Targets"))
        self.pushButton_chooseTarget.setWhatsThis(_translate("MainWindow", "<html><head/><body><p>push the button then close program</p></body></html>"))
        self.pushButton_chooseTarget.setText(_translate("MainWindow", "Choose"))
        self.pushButton_clearTarget.setText(_translate("MainWindow", "Clear"))
        self.label_covariance.setText(_translate("MainWindow", "Convariances"))
        self.pushButton_chooseCovariance.setWhatsThis(_translate("MainWindow", "<html><head/><body><p>push the button then close program</p></body></html>"))
        self.pushButton_chooseCovariance.setText(_translate("MainWindow", "Choose"))
        self.pushButton_clearCovriance.setText(_translate("MainWindow", "Clear"))
